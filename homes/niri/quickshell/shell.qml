        ...
        PanelWindow {
            ...
            Rectangle {
                ...
                QtObject {
                    ...
                    property int toplineAreaSize: shell.height * 1 / 20
                    property int toplineAreaTop: shell.height / 5
                    property int toplineAreaMargin: (toplineAreaSize - height) / 2
                    property int y: toplineAreaTop + toplineAreaMargin
                }
